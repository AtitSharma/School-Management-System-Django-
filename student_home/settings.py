"""
Django settings for student_home project.
...
SECRET_KEY = 'django-insecure-k95!hdq2nx(s1#)t58m_km=ij!vi+$sl@78tzr^56ms=4m^7e$'
...
ROOT_URLCONF = 'student_home.urls'
...
WSGI_APPLICATION = 'student_home.wsgi.application'
